...
parser.add_argument("-e","--error_correction",default=False,type=bool,help="For error correction! Default: False")
parser.add_argument("-r","--filter_",default=False,type=bool,help="Filter! Default: False")
